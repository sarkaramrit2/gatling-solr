...
docker exec kubectl-support kubectl get secret okta-api-token --namespace=default --export -o yaml | docker exec kubectl-support kubectl apply --namespace=${GCP_K8_CLUSTER_NAMESPACE} -f -
